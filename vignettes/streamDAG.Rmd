...
names = mur_coords[,1]
spatial.plot(murphy_spring, x, y, names, plot.bg = "white", cex.text = .7,arrow.col = "lightblue", col = "lightblue")
```
...
spatial.plot(G1, x, y, names, plot.bg = "white", cex.text = .7,arrow.col = "lightblue", col = "lightblue")
```
...
spatial.plot(G1, x, y, names, plot.dry = TRUE, plot.bg = "white", cex.text = .7,arrow.col = "lightblue", col = "lightblue")
```
...
spatial.plot(G1, x, y, names, plot.dry = TRUE, plot.bg = "white", cex.text = .7,arrow.col = "lightblue", col = "lightblue", cnw = spc)
```
...
spatial.plot(G2, x, y, names, plot.bg = "white", cex.text = .7,arrow.col = "lightblue", col = "lightblue")
```
...
data(kon_coords)
spatial.plot(kon_full, kon_coords[,3], kon_coords[,2], names = kon_coords[,1], arrow.col = "lightblue", col = "lightblue", plot.bg = "white")
```
...
spatial.plot(K0521, kx, ky, kn, xaxt = "n", cex.text = 0, arrow.col = "lightblue", col = "lightblue", plot.bg = "white"); legend("topright", bty = "n", legend = "A", cex = 2)
spatial.plot(K0528, kx, ky, kn, xaxt = "n", cex.text = 0, arrow.col = "lightblue", col = "lightblue", plot.bg = "white"); legend("topright", bty = "n", legend = "B", cex = 2)
spatial.plot(K0604, kx, ky, kn, cex.text = 0, arrow.col = "lightblue", col = "lightblue", plot.bg = "white"); legend("topright", bty = "n", legend = "C", cex = 2)
