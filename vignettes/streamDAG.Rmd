...
The *streamDAG* package is built under the basic idiom of the *igraph* package [@csardi], and most of its functions utilize *igraph* basis algorithms.  Newest (developmental) versions of *streamDAG* can be obtained from the public GitHub repository: https://github.com/moondog1969/streamDAG. The package maintainer is Ken Aho (ahoken@isu.edu).  An authoritative introduction to the *streamDAG* package can be found in [@aho2023DAG].


As noted earlier, newest versions of the *streamDAG* package can be installed from the R console via GitHub, after installing the package *devtools*.  In particular, use: 
