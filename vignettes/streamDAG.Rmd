...
Newest versions of the *streamDAG* package can be installed from the R console directly, after installing the package *devtools*.  In particular, use: 
...
The package will also be housed on the Comprehensive R Archive Network [(CRAN)](https://cran.r-project.org/) beginning in September 2023. Following this inception, *streamDAG* can be installed directly from CRAN mirrors using:
