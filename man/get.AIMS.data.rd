...
\description{
The function creates a list of associated dataframes for particular Aquatic Intermittency Effects on Microbiomes in Streams (AIMS) graph objects. AIMS is an  NSF EPSCoR funded project (OIA 2019603). Dataframes currently these include one of more of \code{$coords} \code{$arc.length}
\code{$node.pa}.}
\usage{
